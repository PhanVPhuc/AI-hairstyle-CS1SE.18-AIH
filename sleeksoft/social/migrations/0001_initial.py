# Generated by Django 4.1.3 on 2023-05-07 21:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Phone_number', models.CharField(blank=True, max_length=500, null=True, verbose_name='Số điện thoại')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.TextField(blank=True, null=True, verbose_name='Nội dung bình luận User')),
                ('body_admin', models.TextField(blank=True, null=True, verbose_name='Admin trả lời bình luận User')),
